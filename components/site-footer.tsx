    ...
    <footer className="border-t border-border bg-card">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 py-10 md:flex-row md:justify-between">
        <div className="text-center md:text-right">
          <p className="text-sm font-semibold text-foreground">analist0</p>
        ...
        <nav className="flex gap-6 text-sm text-muted-foreground" aria-label="Footer navigation">
          ...
          <Link href="/tutorials" className="transition-colors hover:text-foreground">
            מדריכים
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="https://twitter.com/analist0"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground transition-colors hover:text-foreground"
            aria-label="Twitter"
          ...
          <Link
            href="https://linkedin.com/in/analist0"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground transition-colors hover:text-foreground"
            aria-label="LinkedIn"
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-6xl px-4 py-4">
          <p className="text-center text-xs text-muted-foreground">
            {new Date().getFullYear()} analist0. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
